...
namespace GameObject
{
    ...
    {
    public:
        PulseLaser(sf::Vector2f position, float angle, Color &color, sf::FloatRect &borderRect, ParticleSystemProp &prop, int thickness = 7, float delay = 0.6f, float duration = 0.3f, int dashLineLength = 28);
