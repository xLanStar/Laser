...
GameObject::Text::Text(sf::Vector2f position, int characterSize, Color &color, sf::Font &font, std::string str) : GameObject(color, position)
{
    text.setFont(font);
    setColor(color);
    setText(str);
...
sf::FloatRect GameObject::Text::getGlobalBounds() const // 取得整個容器空間的邊界
{
